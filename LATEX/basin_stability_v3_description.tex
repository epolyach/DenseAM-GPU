...
$P$ range           & $20{,}000$--$500{,}000$ \;(power-law, $\gamma\!=\!10$) & $e^{\alpha N}$, up to ${\sim}\,10^{12}$ \;(derived from $N$) \\
$N$ range           & $24$--$990$ \;($N = \ln P / \alpha$) & $50$--$990$ \;($N_{\min} = 50$ enforced) \\
Active patterns     & All $P$ & $K \ll P$ via Poisson + truncated normal \\[4pt]
\multicolumn{3}{l}{\textit{Monte Carlo protocol}} \\[2pt]
Initialization      & \multicolumn{2}{l}{$\varphi_{\mathrm{init}} \!\sim\! \mathrm{U}(0.75,\, 1.0)$} \\
Equilibration       & \multicolumn{2}{l}{$2^{14} = 16{,}384$ steps (unmeasured)} \\
Sampling            & \multicolumn{2}{l}{$2^{12} = 4{,}096$ steps ($\varphi$ measured)} \\
Trials              & $512 \to 64$ (linear in $\alpha$) & $512$ \;($\alpha \le 0.50$); $512 \to 449$ \;($\alpha > 0.50$) \\
