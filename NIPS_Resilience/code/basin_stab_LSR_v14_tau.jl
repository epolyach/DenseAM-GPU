...
const PROBE_POINTS = [
    ...
    (0.28, 0.25,  50_000,    32),
    # ── MEDIUM (minutes each) ──
    (0.20, 0.40, 100_000,    64),
    (0.22, 0.40, 100_000,    32),
    (0.24, 0.40,  50_000,    16),
    (0.26, 0.30, 100_000,    64),
    (0.28, 0.20, 100_000,    64),
    (0.28, 0.15, 200_000,   128),
    (0.24, 0.30, 200_000,   128),
    (0.26, 0.25, 200_000,   128),
    (0.22, 0.30, 300_000,   250),
    (0.26, 0.20, 300_000,   250),
    (0.24, 0.25, 300_000,   250),
    # ── SLOW (tens of minutes each) ──
    (0.20, 0.30, 500_000,   500),
    (0.24, 0.20, 500_000,   250),
    (0.22, 0.25, 500_000,   250),
    (0.24, 0.15, 500_000,   500),
    (0.20, 0.25, 500_000,   500),
    (0.22, 0.20, 500_000,   500),
]
