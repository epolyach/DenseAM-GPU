#=
GPU-Accelerated LSE Alpha Sweep – Log-T + Wide P range (v2)
- Log-spaced T grid (0.01 → 2.5, 50 points) matching LSR v5
- P range: 500–20,000 (matching LSR v5)
...
function main()
    ...
    println("=" ^ 70)
    println("LSE Alpha Sweep – GPU v2 (Log-T, P=500–20000, N_EQ=50000)")
    println("=" ^ 70)
    dev = CUDA.device()
    ...
    # ── Save CSV ──
    csv_file = "CSV/lse_longeq_v2.csv"
