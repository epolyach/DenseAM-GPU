...
save("maps_longeq.png", fig, px_per_unit=2)
println("✓ PNG saved: maps_longeq.png")

save("maps_longeq.eps", fig)
println("✓ EPS saved: maps_longeq.eps")

println("\nLong equilibration figures generated:")
println("  - maps_longeq.png (raster, presentations)")
println("  - maps_longeq.eps (vector, publication quality)")
