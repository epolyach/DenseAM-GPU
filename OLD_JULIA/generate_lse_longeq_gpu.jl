#=
GPU-Accelerated LSE Alpha Sweep – Long Equilibration Test
- Same as base (P 200–5000, 256 trials) but N_EQ = 50,000 (10× longer)
- Tests whether insufficient equilibration causes metastability artifacts
- Output: lse_longeq.csv
=#
...
function main()
    ...
    println("=" ^ 70)
    println("LSE Alpha Sweep – GPU (Long Equilibration, N_EQ=50000)")
    println("=" ^ 70)
    dev = CUDA.device()
