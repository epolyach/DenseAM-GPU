...
# ──────────────── Read data (Scale 3: P 10k–300k) ────────────────

data_lse = CSV.read("lse_s3.csv", DataFrame)
data_lsr = CSV.read("lsr_s3.csv", DataFrame)
...
savefig(fig, "maps3.png")
println("Combined plot saved: maps3.png")
