...
save("maps_prod.png", fig, px_per_unit=2)
println("✓ PNG saved: maps_prod.png")

save("maps_prod.eps", fig)
println("✓ EPS saved: maps_prod.eps")

println("\nProduction figures generated:")
println("  - maps_prod.png (raster, presentations)")
println("  - maps_prod.eps (vector, publication quality)")
