...
# ──────────────── Read data (Scale 2: P 2000–50000) ────────────────

data_lse = CSV.read("lse_s2.csv", DataFrame)
data_lsr = CSV.read("lsr_s2.csv", DataFrame)
...
savefig(fig, "maps2.png")
println("Combined plot saved: maps2.png")
