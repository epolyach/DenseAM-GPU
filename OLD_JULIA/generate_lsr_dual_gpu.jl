#=
GPU-Accelerated LSR Alpha Sweep – Dual Initialization + Parallel Tempering
...
- Output: lsr_dual_warm.csv, lsr_dual_cold.csv
=#
...
function main()
    ...
    println("=" ^ 70)
    println("LSR Alpha Sweep – GPU (Dual Init + PT, N_EQ=$N_EQ, b=$(round(b_lsr, digits=3)))")
