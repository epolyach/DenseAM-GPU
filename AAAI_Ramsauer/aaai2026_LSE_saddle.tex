...
\hline
$0.30$ & $\approx 0.30$ & $\approx 0.80$ & $\mathrm{n/a}$ \\
$0.40$ & $\approx 0.32$ & $\approx 0.49$ & $0.474$ {\small(N=1000)} \\
$0.50$ & $\approx 0.17$ & $\approx 0.28$ & $0.264$ {\small(N=1000)} \\
$0.55$ & $\approx 0.10$ & $\approx 0.15$ & $0.198$ {\small(N=1000)} \\
\hline
\end{tabular}
\end{center}
...
\(\alpha=0.30\): no finite boundary (N=1000); \(\alpha=0.40\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.474\) (N=1000), vs leading-order \(0.509\); \(\alpha=0.50\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.264\) (N=1000), vs leading-order \(0.262\); \(\alpha=0.55\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.198\) (N=1000), vs leading-order \(0.151\).
