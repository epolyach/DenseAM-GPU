...
\hline
$0.30$ & $\approx 0.30$ & $\approx 0.80$ & $0.704$ {\small(N=1000)} \\
$0.40$ & $\approx 0.32$ & $\approx 0.49$ & $0.445$ {\small(N=1000)} \\
$0.50$ & $\approx 0.17$ & $\approx 0.28$ & $0.241$ {\small(N=1000)} \\
$0.55$ & $\approx 0.10$ & $\approx 0.15$ & $0.148$ {\small(N=1000)} \\
\hline
\end{tabular}
\end{center}
...
\(\alpha=0.30\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.704\) (N=1000), vs leading-order \(0.799\); \(\alpha=0.40\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.445\) (N=1000), vs leading-order \(0.509\); \(\alpha=0.50\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.241\) (N=1000), vs leading-order \(0.262\); \(\alpha=0.55\): \(T_{\mathrm{sp}}^{\mathrm{MC}}=0.148\) (N=1000), vs leading-order \(0.151\).
