#=
GPU-Accelerated LSR Basin Stability Test (v6)
────────────────────────────────────────────────────────────────────────
...
function main()
    ...
    println("=" ^ 70)
    println("LSR Basin Stability Test – GPU v6 (b=$(round(b_lsr, digits=3)))")
    ...
    # ── Write CSV header ──
    csv_file = "basin_stab_LSR_v6.csv"
