#=
GPU-Accelerated LSR Basin Stability Test (v1)
────────────────────────────────────────────────────────────────────────
...
const PHI_MIN     = F(0.75)           # Minimum initial alignment (above φ_c≈0.707)
...
function main()
    ...
    println("=" ^ 70)
    println("LSR Basin Stability Test – GPU v1 (b=$(round(b_lsr, digits=3)))")
    println("=" ^ 70)
