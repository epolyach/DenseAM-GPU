# Paper scheme: Full at fixed N = 25 (validation run; code-internal name "honest").
# Protocol follows Petrova (2026), arXiv:2603.13350; theory and parameters from
# Petrova et al. (2026), arXiv:2604.07401.
#=
...
Run pattern: assumes a working CUDA device.
────────────────────────────────────────────────────────────────────────────────
=#
