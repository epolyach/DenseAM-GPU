...
\begin{abstract}
\textbf{We study the memory capacity of modern Hopfield networks (Dense Associative Memory models) for structured data, such as binary patterns and low-dimensional manifolds, extending classical analyses of unstructured patterns.}
